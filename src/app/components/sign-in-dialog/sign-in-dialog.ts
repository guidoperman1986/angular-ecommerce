  ...
  template: `
    <div class="p-8 max-w-[400px] flex flex-col bg-white rounded-xl">
      <div class="flex justify-between mb-2">
        <h2 class="text-xl font-medium self-center">Sign In</h2>
...
export class SignInDialog {
  ...
  signIn() {
    ...
    this.userStore.signIn({ email, password, checkout: this.data?.checkout, dialogId: this.dialogRef.id } as SignInParams);
  }
