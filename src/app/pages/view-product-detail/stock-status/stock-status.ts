  ...
  template: `
    @if (inStock()) {
      <div class="flex items-center gap-2 border border-gray-200 rounded-lg px-3 py-3 bg-white w-full">
        ...
        <span class="text text-xs text-gray-800">In stock and ready to ship</span>
      </div>
    } @else {
      <div class="flex items-center gap-2 border border-red-700 rounded-lg px-3 py-3 bg-white w-full danger">
        ...
        <span class="text-xs">The item is currently out of stock. Add it to your wishlist to be notified when it's back in stock.</span>
      </div>
    }
  `,
  styles: ``,
